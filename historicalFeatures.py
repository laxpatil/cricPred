...
for doc in collection.find():
    if doc['info']['match_type']=='ODI':
        ...
        if team1 in countries:
            ...
            NUM_MATCHES[team1]=NUM_MATCHES[team1]
        ...
        if team2 in countries:
            ...
            NUM_MATCHES[team2]=NUM_MATCHES[team2]
...
fileHeader="Team,Runs Scored,Wickets Lost,Got All Out,Runs Conceded,Opponent Wickets Taken,Opponent All Out "
openFile.write(fileHeader)
openFile.write("\n")
for team in countries:
    print team +" : "+ str(RUNS[team])
    n=NUM_MATCHES[team]
    feature="" + team + "," + str(float(RUNS[team]/n)) + "," + str(float(WICKETS_LOST[team]/n)) + "," + str(float(GOT_ALL_OUT[team]/n)) + "," + str(float(CONCEDED_RUNS[team]/n)) + "," + str(float(OPPONENT_WICKETS_TAKEN[team]/n)) + "," + str(float(OPPONENT_ALL_OUT[team]/n)) 
